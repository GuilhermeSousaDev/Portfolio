  ...
  return (
    <Box sx={{ mt: 10 }}>
      ...
      <Typography
        ...
        sx={{ width: "50%", mb: 5, typography: { xs: 'subtitle1', sm: 'h6', md: 'h5' } }}
      >
        Fullstack Developer
      </Typography>
      <Typography 
        ...
        color="text.disabled"
      >
        I am 18 years old and a programming student passionate about the world of technology. I live in Macaúbas-BA, Brazil, and have been studying programming for two years. I am always seeking new knowledge and challenges to develop professionally.
        <br /> <br />
        I am excited about the possibility of showcasing my
